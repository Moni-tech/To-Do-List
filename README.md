...
This project was made to practice core web development skills:

- 💻 Building interactive pages using JavaScript.
- 🎨 Styling layouts with CSS.
- 💾 Managing browser data using localStorage.
...
4. ☑️ To mark a task as completed, check the checkbox.
5. ✏️ To edit a task, double-click on its text.
6. 🗑️ To delete a task, click the "Delete" button.

## 🛠️ Technologies Used

- 🌐 **HTML**: Structure of the application.
- 🎨 **CSS**: Styling with gradients, animations, and responsive design.
- ⚡ **JavaScript**: Functionality for adding, editing, deleting, and persisting todos using localStorage.
...
2. 🌐 Open `index.html` directly in any modern web browser (Chrome, Firefox, Safari, etc.).
3. 💾 The app will run locally and store data in your browser's localStorage.
